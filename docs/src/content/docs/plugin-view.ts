    ...
    },
    {
      ...
      rows: [
        [
          ...
          "ViewEngine",
          "—",
          "Required. An adapter (`eta`/`ejs`/`handlebars`) or your own.",
        ],
        [
          "root",
          "string",
          "—",
          "Required. Directory templates resolve against; names can't escape it.",
        ],
        ...
        [
          ...
          "boolean",
          "true",
          "Cache compiled templates; set `false` in dev to pick up edits.",
        ],
        ...
        [
          ...
          "{}",
          "Data merged into every render; `data` overrides it.",
        ],
      ],
    },
    {
