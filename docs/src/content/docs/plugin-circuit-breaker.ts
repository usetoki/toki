...
app.post("/charge", breaker);`,
    ...
    },
    {
      ...
      rows: [
        ...
        [
          "fallback",
          "(req) => HandlerResult | Promise<…>",
          "none",
          "Served when open or when the call fails, instead of `503`/re-throw.",
        ],
        [
          "onOpen / onHalfOpen / onClose",
          "() => void",
          "none",
          "Transition hooks for logging and metrics.",
        ],
      ],
    },
    {
