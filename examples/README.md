...
| `tcp-tls-peer.ts`   | a full TLS peer — two listeners (c2s/s2s) routed by `socket.localPort`, STARTTLS `upgradeTLS`, ALPN, mutual TLS, exporter channel binding, `peerCertificate` |
