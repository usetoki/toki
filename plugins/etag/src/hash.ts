...
// FNV-1a (32-bit, via Math.imul) prefixed with the byte length. Allocation-free and fast.
// The length prefix makes a collision between two different bodies vanishingly unlikely,
// which is all a cache validator needs. Format: "<len-hex>-<hash-hex>".
